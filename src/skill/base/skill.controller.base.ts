...
import { getListSkillDto } from "./getListSkill.dto";
...
export class SkillControllerBase {
  ...
  async create(
    @common.Body() data: SkillCreateInput,
  ...
  @swagger.ApiOkResponse({ type: getListSkillDto })
  @swagger.ApiForbiddenResponse()
  @swagger.ApiQuery({
    type: () => SkillFindManyArgs,
    style: "deepObject",
    explode: true,
  })
  async findMany(
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"Skill"} is forbidden for roles: ${roles}`
      );
    }
